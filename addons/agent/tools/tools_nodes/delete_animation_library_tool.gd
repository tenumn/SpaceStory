...
func do_action(tool_call: AgentModelUtils.ToolCallsInfo) -> Dictionary:
	...
	return {"success": true, "message": "动画库 '" + library_name + "' 已删除。"}
